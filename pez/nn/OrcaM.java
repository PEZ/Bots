...
// $Id: OrcaM.java,v 1.1 2003/04/11 20:44:51 peter Exp $
...
public class OrcaM extends AdvancedRobot {
    ...
    private final static int NN_CANDIDATES = 5;
    ...
    private final static double NN_CANDIDATE_RATE_DEPTH = 90;
    private final static double ALLOWED_HIT_RATE_DEGRADATION = -2.5;
    ...
    private static float[] nnHistoryArray = new float[HISTORY_DEPTH * HISTORY_ITEMS + 6];
...
System.out.println("Best hitRate: " + nnCandidate[0].getHitRate());
    ...
    private void record() {
        ...
        rollingBearingDelta_2 = rollingAvg(rollingBearingDelta_2, enemyBearingDelta, 7, 1);
        rollingBearingDelta_3 = rollingAvg(rollingBearingDelta_3, enemyBearingDelta, 30, 1);
        rollingDistanceDelta_1 = rollingAvg(rollingDistanceDelta_1, enemyDistanceDelta, 3, 1);
        /*
	...
	private float[] history = new float[HISTORY_DEPTH * HISTORY_ITEMS + 6];
