...
public class Pugilist extends AdvancedRobot {
	...
	public void run() {
		...
		fieldRectangle = new Rectangle2D.Double(WALL_MARGIN, WALL_MARGIN,
				BATTLE_FIELD_WIDTH - WALL_MARGIN * 2, BATTLE_FIELD_HEIGHT
						- WALL_MARGIN * 2);
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		ew.visits = EnemyWave.factors[distanceIndex = (int) Math.min(
				...
				(enemyDistance / (MAX_DISTANCE / Wave.DISTANCE_INDEXES)))]
						[lastRobotVelocityIndex][lastRobotVelocityIndex = (int) Math
				.abs(robotVelocity / 2)];
