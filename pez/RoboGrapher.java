...
// $Id: RoboGrapher.java,v 1.1 2003/11/05 20:58:27 peter Exp $

public class RoboGrapher extends Canvas implements ActionListener, ItemListener, WindowListener {
    private static int[] segmentationsLengths = { 3, 5, 5, 2 };
    ...
    public static void main(String args[]) {
        ...
        java.awt.Frame frame = new java.awt.Frame("Robo Grapher");
        frame.setSize(715, 540);
        folder = new File("pez/RoboGrapherBot.data/");
