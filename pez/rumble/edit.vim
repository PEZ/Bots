...
silent only
cd C:\robocode\robots\pez\rumble
set shortmess=aoO
...
badd +84 CassiusClay.java
badd +98 pgun\Bee.java
badd +156 utils\Wave.java
badd +80 utils\PUtils.java
badd +332 pmove\Butterfly.java
...
exe 'resize ' . ((&lines * 1 + 42) / 85)
wincmd w
exe 'resize ' . ((&lines * 1 + 42) / 85)
wincmd w
exe 'resize ' . ((&lines * 69 + 42) / 85)
wincmd w
exe 'resize ' . ((&lines * 9 + 42) / 85)
wincmd w
argglobal
edit CassiusClay.java
setlocal noarabic
setlocal autoindent
setlocal autoread
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 113 - ((49 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
